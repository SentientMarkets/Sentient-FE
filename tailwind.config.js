  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "cyber-glow":
          "linear-gradient(180deg, rgba(76, 84, 95, 0.15) 0%, rgba(56, 66, 78, 0.05) 100%)",
        "blockchain-grid":
          "linear-gradient(rgba(76, 84, 95, 0.05) 2px, transparent 2px), linear-gradient(90deg, rgba(76, 84, 95, 0.05) 2px, transparent 2px)",
      },
      boxShadow: {
